<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bronchities.aspx.cs" Inherits="WebApplication1.UI.Bronchities" %>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <h1>These are the Symptoms of Bronchities</h1>
            <ul>
                <li class="vertical">Cough</li>
                <li class="vertical">Fever</li>
                <li class="vertical">Tightness</li>
                <li class="vertical">Shortnessof Breath</li>
                <li class="vertical">Headache</li>
                <li class="vertical">Sore throat</li>
            </ul>
