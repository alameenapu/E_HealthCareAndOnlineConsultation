<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Blind.aspx.cs" Inherits="WebApplication1.UI.Blind" %>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <h1>These are the Symptoms of Blind</h1>
            <ul>
                <li class="vertical">Blindness</li>
                <li class="vertical">Bluured vision</li>
                <li class="vertical">Brain tumor</li>
            </ul>
