<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Abscess.aspx.cs" Inherits="WebApplication1.UI.Abscess" %>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <h1>These are the Symptoms of Abscess</h1>
            <ul>
                <li class="vertical">Lump</li>
                <li class="vertical">Chills</li>
                <li class="vertical">Fever</li>
                <li class="vertical">Skin open sore</li>
