<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Trauma.aspx.cs" Inherits="WebApplication1.UI.Trauma" %>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <h1>These are the Symptoms of Trauma</h1>
            <ul>
                <li class="vertical">White Skin</li>
                <li class="vertical">Shock</li>
                <li class="vertical">Hematoma</li>
            </ul>
